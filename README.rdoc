...
The original owner has not been updating the gem for almost a year now, breaking compatibility with the existing Paypal APIs. You can use this fork which is actively mantained to ensure it is working properly.
